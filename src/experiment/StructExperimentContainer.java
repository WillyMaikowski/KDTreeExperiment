...
public class StructExperimentContainer {
	...
	public StructExperimentContainer( String kdTreeName, String pointType, int size ) {
	...
	public double getAverageHeight() {
		if( this.n > 0 ) return this.heightSum / this.n;
		return 0L;
	}
	...
	/**
	 * NombreAlgoritmo tipoDePuntos size n avgHeight avgTime avgSize stdHeight stdTime stdSize
	 * 
	 * @return
	 */
	public String getResult() {
		return "[" + this.kdTreeName + "\t" + this.pointType + "\t" + this.size + "\t" + this.n + "\t"
		      + this.getAverageHeight() + "\t" + this.getAverageTime() + "\t" + this.getAverageSize() + "\t"
		      + this.getheightStd() + "\t" + this.getTimeStd() + "\t" + this.getsizeStd() + "\t" + "]";
	}
